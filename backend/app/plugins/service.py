...
def install_plugin(entry: dict) -> dict:
    from ..admin.routes import write_skill_files
    ...
    with connect() as connection:
        with connection.cursor() as cursor:
            ...
            for skill in manifest["skills"]:
                ...
                write_skill_files({"name": full_name, "description": skill["description"], "argument_hint": skill["argument_hint"], "triggers": skill["triggers"], "body": skill["body"], "resources": skill["resources"]})
...
def uninstall_plugin(slug: str) -> dict:
    from ..admin.routes import delete_skill_files
