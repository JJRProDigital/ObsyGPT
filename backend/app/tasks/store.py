...
def create_task(user_id: int, goal: str, mode: str = "act", scheduled_at=None, agent_id: int | None = None, project_id: int | None = None, recurrence: str | None = None) -> dict:
    with connect() as connection:
        with connection.cursor() as cursor:
            cursor.execute(
                ...
                """,
                (user_id, goal, mode, "pending", scheduled_at, agent_id, project_id, recurrence),
            )
